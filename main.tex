...
Another optimization here is finding the repeated segments in the edge curves that naturally appear
...
The second phase of tiling filters out the entities from the lower levels. We do not change the highest, the most detailed level.
