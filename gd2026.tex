...
see Figure~\ref{fig:collapse}(a). We eliminate these detours by
\emph{collapsing} such vertices selectively to the corresponding node
center. Walking the right chain of the sleeve outward from~$s$, we
...
diagonal is preserved from the uncollapsed geometry. The two collapsed
vertices in Figure~\ref{fig:collapse}(a), one on each chain, are
marked in yellow.
