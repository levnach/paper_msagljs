...
graphs\footnote{\url{https://microsoft.github.io/msagljs/renderer-webgl/index.html}}
and an SVG renderer for smaller, editable
graphs\footnote{\url{https://microsoft.github.io/msagljs/renderer-svg/index.html}}.
...
tile-pyramid and node-ranking scheme on which we build, but it runs
...
the browser with vector tiles and per-level sleeve rerouting. Cornac~\cite{perrot2018cornac} handles huge
