...
Triangulation \cdt{} on the setq of these
...
pointers. This gives a speedup comparing with $A*$ routing, for example on the Game of Thrones
...
The renderer supports pan, zoom, hover highlighting of nodes and
edges. Hovering an edge highlights it and its incident nodes. Hovering
on a node highglights the node, its one hop neighbors, and two-hops
neigbors, in different colors.

The search \texttt{zoomTo} API animates the
viewport to the target rectangle with smooth transitions.
%% ═══════════════════════════════════════════════════════════════════
