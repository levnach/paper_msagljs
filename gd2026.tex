...
pass by $\sim$22\,\% and $\sim$37\,\% respectively. Table~\ref{tab:routing-modes}
...
reaching $+71$\,\% on \texttt{facebook\_combined} and $+63$\,\% on
\texttt{ca-HepPh}; the vertex-cover heuristic then shaves a further
$12$--$47$\,\% off those same graphs. The Delaunay mesh
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lrrrrrrr@{}}
    ...
    \midrule
    gameofthrones      &     331 &     198 &   0.22 &   0.14 &   0.11 & $+36$\,\% & $+22$\,\% \\
    composers          &  2\,645 &  1\,281 &   8.71 &   5.96 &   3.78 & $+32$\,\% & $+37$\,\% \\
    ca-GrQc            &  5\,241 &  2\,796 &   7.17 &   6.33 &   3.87 & $+12$\,\% & $+39$\,\% \\
    facebook\_combined &  3\,663 &  3\,045 &  45.82 &  13.29 &  11.65 & $+71$\,\% & $+12$\,\% \\
    ca-HepTh           &  9\,875 &  5\,003 &  56.98 &  46.35 &  26.94 & $+19$\,\% & $+42$\,\% \\
    ca-HepPh           & 12\,006 &  7\,032 & 362.0  & 135.5  &  91.7  & $+63$\,\% & $+32$\,\% \\
    ca-CondMat         & 23\,133 & 13\,564 & 576.7  & 379.6  & 200.4  & $+34$\,\% & $+47$\,\% \\
    deezer\_europe     & 21\,060 & 13\,450 & 526.9  & 470.1  & 375.8  & $+11$\,\% & $+20$\,\% \\
    delaunay\_n15      & 28\,467 & 23\,456 &  26.08 &  31.59 &  32.08 & $-21$\,\% & $-2$\,\% \\
    \bottomrule
  \end{tabular}
  \caption{Sleeve-search times of the three routing modes on the
    benchmark graphs of Table~\ref{tab:perf}. \emph{Srcs} is the number
    of distinct edge endpoints in the demand graph; \emph{VC} is the
    number of Dijkstra trees actually launched after the greedy
    maximum-degree vertex-cover reorientation of
    Section~\ref{sec:sleeve}. The CDT-construction phase, identical
    across modes, is excluded so that only the search costs are
    compared. \emph{Dijk./A*}~$=$~$(\text{A*}-\text{Dijk.})/\text{A*}$;
    \emph{VC/Dijk.}~$=$~$(\text{Dijk.}-\text{Dijk.+VC})/\text{Dijk.}$\@.}
