...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.65\textwidth]{collapse_OSHA_SMALLJON.pdf}
  \caption{Effect of vertex collapse on the OSHA--SMALLJON edge of the Game of Thrones graph. Light blue: the 12-triangle sleeve. Purple dashed: perimeter of the sleeve after collapse, where each pair of obstacle corners that share a node has been merged into the node center. Orange dashed: funnel path before collapse, 7 waypoints. Red solid: funnel path after collapse, 5 waypoints, 21\% shorter. Collapsing obstacle vertices to the node center widens the funnel opening at each endpoint and removes the spurious detours around obstacle corners.}
  \label{fig:collapse}
\end{figure}
