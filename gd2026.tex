...
the corridor router's obstacle inflation and leaves a visible gap
...
must be rerouted on each level as well. We rerun the corridor router,
Section~\ref{sec:corridor}, on the set of the level edges.
...
Table~\ref{tab:perf} reports the performance of the Dijkstra-tree corridor router, Section~\ref{sec:sleeve}. For each graph, we report the number of CDT triangles, free-space triangles, the total number of portal triangles across all nodes, and the total routing time.
