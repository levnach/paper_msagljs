...
Because the routes stored in the tiles were already rerouted per level
by the sleeve router of Section~\ref{sec:sleeve-routing}, every level
the user views is visually self-consistent: the displayed edges are
the geodesics around exactly the obstacles drawn on that level, not a
subsampling of finer routes.
