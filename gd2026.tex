...
window. Within each level, the displayed nodes are the PageRank
prefix at the adaptive scales chosen for that level, and the
displayed edges are the geodesics around exactly those obstacles,
computed by the sleeve router of Section~\ref{sec:sleeve-routing},
and not a subsampling of finer routes.
