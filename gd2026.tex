...
window. Within each level, the displayed edges are the geodesics
around exactly the obstacles drawn on that level, computed by the
sleeve router of Section~\ref{sec:sleeve-routing}, and not a
