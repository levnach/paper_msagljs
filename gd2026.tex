...
finishing a level we know we will throw away. On every benchmark
graph in Table~\ref{tab:max-per-tile} the first condition fires; the
second and third are defensive guards that bound depth on
